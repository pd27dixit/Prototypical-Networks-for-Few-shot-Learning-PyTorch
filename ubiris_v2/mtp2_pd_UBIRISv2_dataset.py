...
class UBIRISv2Dataset(Dataset):
    def __init__(self, mode='train', root='dataset', transform=None, target_transform=None):
        ...
        '''
        super(UBIRISv2Dataset, self).__init__()
    ...
    def _load_img(self, path, idx):
        ...
        img = img.resize((400, 300))  # Resize to 28x28 like Omniglot
    ...
    def _find_items(self):
        ...
        for cls in self.classes:
            ...
            images = [
                ...
                (img, cls, class_path) for img in os.listdir(class_path) if img.endswith('.tiff')
            ]
            items.extend(images)
