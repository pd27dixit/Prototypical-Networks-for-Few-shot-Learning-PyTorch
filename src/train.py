...
# def init_dataset(opt, mode):
#     print(f"[INFO] Initializing dataset in {mode} mode...")  
#     dataset = OmniglotDataset(mode=mode, root=opt.dataset_root)
...
# #     sampler = init_sampler(opt, dataset.y, mode)
# #     print(f"Sampler initialized: {sampler}")
# #     print(f"Sampler length: {len(sampler)}")

# #     dataloader = torch.utils.data.DataLoader(dataset, batch_sampler=sampler)
# #     print(f"Dataloader initialized: {dataloader}")
...
#     '''
#     options = get_parser().parse_args()
#     print("Parsed arguments:", vars(options))
#     print(f"Dataset Root: {options.dataset_root}")
#     print(f"Experiment Root: {options.experiment_root}")
